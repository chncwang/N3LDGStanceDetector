...
bool isTargetWordInTweet(const Feature &feature) {
  ...
  if (firstWord == "#hillaryclinton" || firstWord == "hillary" || firstWord == "illegal") {
    keywords = {"hillary", "clinton"};
  }
  else if (firstWord == "#donaldtrump" || firstWord == "donald" || firstWord == "shooting") {
    keywords = {"donald", "trump"};
  }
  else if (firstWord == "#atheism" || firstWord == "atheism" || firstWord == "@atheist_eh") {
    keywords = { "atheism", "atheist" };
  }
  else if (firstWord == "#climatechange" || firstWord == "climate" || firstWord == "action") {
    keywords = {"climate"};
  }
  else if (firstWord == "#feminism" || firstWord == "feminist" || firstWord == "wrong") {
    keywords = {"feminism", "feminist"};
  }
  else if (firstWord == "#prochoice" || firstWord == "legalization" || firstWord == "@kareemdant") {
